...
if (!$missingTables) {
    ...
    $mapStmt = $pdo->prepare('SELECT rs_rank_name, discord_role_id FROM rs_rank_mappings WHERE discord_guild_id = :guild_id AND discord_role_id IS NOT NULL AND discord_role_id <> ""');
